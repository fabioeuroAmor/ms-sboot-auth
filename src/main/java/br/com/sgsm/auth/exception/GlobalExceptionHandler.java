...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handlePermissaoNegada(PermissaoNegadaException ex, HttpServletRequest request) {
        return problem(HttpStatus.FORBIDDEN, "permissao-negada", "Permissão negada", ex.getMessage(), request);
    }
